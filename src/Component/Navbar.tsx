...
const Navbar: React.FC = () => {
  ...
  const navLinks = [
    { name: 'HOME', href: '/' },
    { name: 'MOST WANTED', href: '/most-wanted' },
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-md text-gray-200 hover:text-white hover:bg-[#B22234]/30 focus:outline-none"
            >
              <FaBars size={20} />
            </button>
          </div>
      ...
      >
        ...
        <div
          className={`
            absolute top-0 left-0 h-full w-64 bg-white shadow-2xl transform transition-transform duration-300
